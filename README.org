...
This is the vericert-fun branch, which implements function-level resource sharing. You can read more about this work on the [[https://mpardalos.xyz/thesis.pdf][relevant Master's Thesis]].
